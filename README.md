...
-  Histropedia --> For the interactive learning, timeline-based and map-based history exploration.
-  Chronas --> For the interactive learning, timeline-based and map-based history exploration.
- 
### AI for adaptive UI and accessibility
- Microsoft's UI Automation framework
- WebArena benchmark's reasearch for web-navigating agents.
- Anthropic's Claude computer
- Google's Project Mariner
- For layout adaptation specifically, research on <BOLD>responsive</BOLD> design AI
- The <bold>A11y<bold> Project for accessibility standards.
